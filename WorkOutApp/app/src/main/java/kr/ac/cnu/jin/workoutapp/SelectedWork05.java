 ...
 */
public class SelectedWork05 extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.selected_work_05);
        ...
        gotoHome.setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                Intent goHome = new Intent(SelectedWork05.this, MainActivity.class);
        ...
        input_time.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v){
                Intent doInputTime = new Intent(SelectedWork05.this, WorkOutTime.class);
