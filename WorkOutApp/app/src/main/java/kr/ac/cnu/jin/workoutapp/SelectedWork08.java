 ...
 */
public class SelectedWork08  extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.selected_work_08);
        ...
        gotoHome.setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                Intent goHome = new Intent(SelectedWork08.this, MainActivity.class);
        ...
        input_time.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v){
                Intent doInputTime = new Intent(SelectedWork08.this, WorkOutTime.class);
